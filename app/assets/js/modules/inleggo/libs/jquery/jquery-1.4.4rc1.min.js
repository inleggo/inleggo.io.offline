 ...
 */
(function(E,B){function ja(a,b,d){if(d===B&&a.nodeType===1){d=a.getAttribute("data-"+b);if(typeof d==="string"){try{d=d==="true"?true:d==="false"?false:d==="null"?null:!c.isNaN(d)?parseFloat(d):Ha.test(d)?c.parseJSON(d):d}catch(e){}c.data(a,b,d)}else d=B}return d}function V(){return false}function ba(){return true}function ka(a,b,d){d[0].type=a;return c.event.handle.apply(b,d)}function Ia(a){var b,d,e=[],f=[],h,k,l,n,v,s,z,C;k=c.data(this,this.nodeType?"events":"__events__");if(typeof k==="function")k=
...
k.preType==="mouseleave"){a.type=k.preType;h=c(a.relatedTarget).closest(k.selector)[0]}if(!h||h!==l)e.push({elem:l,handleObj:k,level:z.level})}}}v=0;for(s=e.length;v<s;v++){f=e[v];if(d&&f.level>d)break;a.currentTarget=f.elem;a.data=f.handleObj.data;a.handleObj=f.handleObj;C=f.handleObj.origHandler.apply(f.elem,arguments);if(C===false||a.isPropagationStopped()){d=f.level;if(C===false)b=false;if(a.isImmediatePropagationStopped())break}}return b}}function Y(a,b){return(a&&a!=="*"?a+".":"")+b.replace(Ja,
...
K,fa;if(typeof i==="boolean"){A=i;i=arguments[1]||{};r=2}if(typeof i!=="object"&&!b.isFunction(i))i={};if(y===r){i=this;--r}for(;r<y;r++)if((F=arguments[r])!=null)for(I in F){J=i[I];K=F[I];if(i!==K)if(A&&K&&(b.isPlainObject(K)||(fa=b.isArray(K)))){if(fa){fa=false;J=J&&b.isArray(J)?J:[]}else J=J&&b.isPlainObject(J)?J:{};i[I]=b.extend(A,J,K)}else if(K!==B)i[I]=K}return i};b.extend({noConflict:function(i){E.$=e;if(i)E.jQuery=d;return b},isReady:false,readyWait:1,ready:function(i){i===true&&b.readyWait--;
...
c.cache;if(!(e&&!f&&typeof b==="string"&&d===B)){if(e)f||(a[c.expando]=f=++c.uuid);else h=a;if(typeof b==="object")if(e)h[f]=c.extend(h[f],b);else c.extend(h,b);else if(e&&!h[f])h[f]={};a=e?h[f]:h;if(d!==B)a[b]=d;return typeof b==="string"?a[b]:a}}},removeData:function(a,b){if(c.acceptData(a)){a=a==E?qa:a;var d=a.nodeType,e=d?a[c.expando]:a,f=c.cache,h=d?f[e]:e;if(b){if(h){delete h[b];d&&c.isEmptyObject(h)&&c.removeData(a)}}else if(d&&c.support.deleteExpando)delete a[c.expando];else if(a.removeAttribute)a.removeAttribute(c.expando);
...
a)});var l=a.split(".");l[1]=l[1]?"."+l[1]:"";if(b===B){d=this.triggerHandler("getData"+l[1]+"!",[l[0]]);if(d===B&&this.length){d=c.data(this[0],a);d=ja(this[0],a,d)}return d===B&&l[1]?this.data(l[0]):d}else return this.each(function(){var n=c(this),v=[l[0],b];n.triggerHandler("setData"+l[1]+"!",v);c.data(this,a,b);n.triggerHandler("changeData"+l[1]+"!",v)})},removeData:function(a){return this.each(function(){c.removeData(this,a)})}});c.extend({queue:function(a,b,d){if(a){b=(b||"fx")+"queue";var e=
...
colspan:"colSpan",tabindex:"tabIndex",usemap:"useMap",frameborder:"frameBorder"};c.fn.extend({attr:function(a,b){return c.access(this,a,b,true,c.attr)},removeAttr:function(a){return this.each(function(){c.attr(this,a,"");this.nodeType===1&&this.removeAttribute(a)})},addClass:function(a){if(c.isFunction(a))return this.each(function(v){var s=c(this);s.addClass(a.call(this,v,s.attr("class")))});if(a&&typeof a==="string")for(var b=(a||"").split(ga),d=0,e=this.length;d<e;d++){var f=this[d];if(f.nodeType===
1)if(f.className){for(var h=" "+f.className+" ",k=f.className,l=0,n=b.length;l<n;l++)if(h.indexOf(" "+b[l]+" ")<0)k+=" "+b[l];f.className=c.trim(k)}else f.className=a}return this},removeClass:function(a){if(c.isFunction(a))return this.each(function(n){var v=c(this);v.removeClass(a.call(this,n,v.attr("class")))});if(a&&typeof a==="string"||a===B)for(var b=(a||"").split(ga),d=0,e=this.length;d<e;d++){var f=this[d];if(f.nodeType===1&&f.className)if(a){for(var h=(" "+f.className+" ").replace(ra," "),
...
if(e<0)return null;var h=b?e:0;for(e=b?e+1:f.length;h<e;h++){var k=f[h];if(k.selected&&(c.support.optDisabled?!k.disabled:k.getAttribute("disabled")===null)&&(!k.parentNode.disabled||!c.nodeName(k.parentNode,"optgroup"))){a=c(k).val();if(b)return a;d.push(a)}}return d}if(sa.test(b.type)&&!c.support.checkOn)return b.getAttribute("value")===null?"on":b.value;return(b.value||"").replace(Qa,"")}return B}var l=c.isFunction(a);return this.each(function(n){var v=c(this),s=a;if(this.nodeType===1){if(l)s=
a.call(this,n,v.val());if(s==null)s="";else if(typeof s==="number")s+="";else if(c.isArray(s))s=c.map(s,function(C){return C==null?"":C+""});if(c.isArray(s)&&sa.test(this.type))this.checked=c.inArray(v.val(),s)>=0;else if(c.nodeName(this,"select")){var z=c.makeArray(s);c("option",this).each(function(){this.selected=c.inArray(c(this).val(),z)>=0});if(!z.length)this.selectedIndex=-1}else this.value=s}})}});c.extend({attrFn:{val:true,css:true,html:true,text:true,data:true,width:true,height:true,offset:true},
attr:function(a,b,d,e){if(!a||a.nodeType===3||a.nodeType===8)return B;if(e&&b in c.attrFn)return c(a)[b](d);e=a.nodeType!==1||!c.isXMLDoc(a);var f=d!==B;b=e&&c.props[b]||b;if(a.nodeType===1){var h=Ra.test(b);if((b in a||a[b]!==B)&&e&&!h){if(f){b==="type"&&Sa.test(a.nodeName)&&a.parentNode&&c.error("type property can't be changed");if(d===null)a.nodeType===1&&a.removeAttribute(b);else a[b]=d}if(c.nodeName(a,"form")&&a.getAttributeNode(b))return a.getAttributeNode(b).nodeValue;if(b==="tabIndex")return(b=
a.getAttributeNode("tabIndex"))&&b.specified?b.value:Ta.test(a.nodeName)||Ua.test(a.nodeName)&&a.href?0:B;return a[b]}if(!c.support.style&&e&&b==="style"){if(f)a.style.cssText=""+d;return a.style.cssText}f&&a.setAttribute(b,""+d);if(!a.attributes[b]&&a.hasAttribute&&!a.hasAttribute(b))return B;a=!c.support.hrefNormalized&&e&&h?a.getAttribute(b,2):a.getAttribute(b);return a===null?B:a}}});var X=/\.(.*)$/,ha=/^(?:textarea|input|select)$/i,Ja=/\./g,Ka=/ /g,Va=/[^\w\s.|`]/g,Wa=function(a){return a.replace(Va,
...
"form"){c.event.add(this,"click.specialSubmit",function(a){var b=a.target,d=b.type;if((d==="submit"||d==="image")&&c(b).closest("form").length){a.liveFired=B;return ka("submit",this,arguments)}});c.event.add(this,"keypress.specialSubmit",function(a){var b=a.target,d=b.type;if((d==="text"||d==="password")&&c(b).closest("form").length&&a.keyCode===13){a.liveFired=B;return ka("submit",this,arguments)}})}else return false},teardown:function(){c.event.remove(this,".specialSubmit")}};if(!c.support.changeBubbles){var W,
wa=function(a){var b=a.type,d=a.value;if(b==="radio"||b==="checkbox")d=a.checked;else if(b==="select-multiple")d=a.selectedIndex>-1?c.map(a.options,function(e){return e.selected}).join("-"):"";else if(a.nodeName.toLowerCase()==="select")d=a.selectedIndex;return d},Z=function(a,b){var d=a.target,e,f;if(!(!ha.test(d.nodeName)||d.readOnly)){e=c.data(d,"_change_data");f=wa(d);if(a.type!=="focusout"||d.type!=="radio")c.data(d,"_change_data",f);if(!(e===B||f===e))if(e!=null||f){a.type="change";a.liveFired=
...
1;d<b.length;)c.proxy(a,b[d++]);return this.click(c.proxy(a,function(e){var f=(c.data(this,"lastToggle"+a.guid)||0)%d;c.data(this,"lastToggle"+a.guid,f+1);e.preventDefault();return b[f].apply(this,arguments)||false}))},hover:function(a,b){return this.mouseenter(a).mouseleave(b||a)}});var xa={focus:"focusin",blur:"focusout",mouseenter:"mouseover",mouseleave:"mouseout"};c.each(["live","die"],function(a,b){c.fn[b]=function(d,e,f,h){var k,l=0,n,v,s=h||this.selector;h=h?this:c(this.context);if(typeof d===
"object"&&!d.preventDefault){for(k in d)h[b](k,e,d[k],s);return this}if(c.isFunction(e)){f=e;e=B}for(d=(d||"").split(" ");(k=d[l++])!=null;){n=X.exec(k);v="";if(n){v=n[0];k=k.replace(X,"")}if(k==="hover")d.push("mouseenter"+v,"mouseleave"+v);else{n=k;if(k==="focus"||k==="blur"){d.push(xa[k]+v);k+=v}else k=(xa[k]||k)+v;if(b==="live"){v=0;for(var z=h.length;v<z;v++)c.event.add(h[v],"live."+Y(k,s),{data:e,selector:s,handler:f,origType:k,origHandler:f,preType:n})}else h.unbind("live."+Y(k,s),f)}}return this}});
...
b,e))});if(typeof a!=="string")a=c(a).detach();return this.each(function(){var b=this.nextSibling,d=this.parentNode;c(this).remove();b?c(b).before(a):c(d).append(a)})}else return this.pushStack(c(c.isFunction(a)?a():a),"replaceWith",a)},detach:function(a){return this.remove(a,true)},domManip:function(a,b,d){var e,f,h=a[0],k=[],l;if(!c.support.checkClone&&arguments.length===3&&typeof h==="string"&&Ca.test(h))return this.each(function(){c(this).domManip(a,b,d,true)});if(c.isFunction(h))return this.each(function(v){var s=
...
b[0].ownerDocument||u;for(var f=[],h=0,k;(k=a[h])!=null;h++){if(typeof k==="number")k+="";if(k){if(typeof k==="string"&&!cb.test(k))k=b.createTextNode(k);else if(typeof k==="string"){k=k.replace(za,"<$1></$2>");var l=(Aa.exec(k)||["",""])[1].toLowerCase(),n=O[l]||O._default,v=n[0],s=b.createElement("div");for(s.innerHTML=n[1]+k+n[2];v--;)s=s.lastChild;if(!c.support.tbody){v=bb.test(k);l=l==="table"&&!v?s.firstChild&&s.firstChild.childNodes:n[1]==="<table>"&&!v?s.childNodes:[];for(n=l.length-1;n>=
...
fontWeight:true,opacity:true,zoom:true,lineHeight:true},cssProps:{"float":c.support.cssFloat?"cssFloat":"styleFloat"},style:function(a,b,d,e){if(!(!a||a.nodeType===3||a.nodeType===8||!a.style)){var f,h=c.camelCase(b),k=a.style,l=c.cssHooks[h];b=c.cssProps[h]||h;if(d!==B){if(!(typeof d==="number"&&isNaN(d)||d==null)){if(typeof d==="number"&&!c.cssNumber[h])d+="px";if(!l||!("set"in l)||(d=l.set(a,d))!==B)try{k[b]=d}catch(n){}}}else{if(l&&"get"in l&&(f=l.get(a,false,e))!==B)return f;return k[b]}}},css:function(a,
b,d){var e,f=c.camelCase(b),h=c.cssHooks[f];b=c.cssProps[f]||f;if(h&&"get"in h&&(e=h.get(a,true,d))!==B)return e;else if(T)return T(a,b,f)},swap:function(a,b,d){var e={},f;for(f in b){e[f]=a.style[f];a.style[f]=b[f]}d.call(a);for(f in b)a.style[f]=e[f]},camelCase:function(a){return a.replace(fb,kb)}});c.curCSS=c.css;c.each(["height","width"],function(a,b){c.cssHooks[b]={get:function(d,e,f){var h;if(e){if(d.offsetWidth!==0)h=na(d,b,f);else c.swap(d,ib,function(){h=na(d,b,f)});if(h<=0){h=T(d,b,b);if(h!=
...
"json"}if(b.dataType==="json"&&(b.data&&U.test(b.data)||U.test(b.url))){d=b.jsonpCallback||"jsonp"+lb++;if(b.data)b.data=(b.data+"").replace(U,"="+d+"$1");b.url=b.url.replace(U,"="+d+"$1");b.dataType="script";var l=E[d];E[d]=function(m){if(c.isFunction(l))l(m);else{E[d]=B;try{delete E[d]}catch(p){}}f=m;c.handleSuccess(b,w,e,f);c.handleComplete(b,w,e,f);s&&s.removeChild(z)}}if(b.dataType==="script"&&b.cache===null)b.cache=false;if(b.cache===false&&k){var n=c.now(),v=b.url.replace(qb,"$1_="+n);b.url=
v+(v===b.url?(ia.test(b.url)?"&":"?")+"_="+n:"")}if(b.data&&k)b.url+=(ia.test(b.url)?"&":"?")+b.data;b.global&&c.active++===0&&c.event.trigger("ajaxStart");n=(n=rb.exec(b.url))&&(n[1]&&n[1].toLowerCase()!==location.protocol||n[2].toLowerCase()!==location.host);if(b.dataType==="script"&&h==="GET"&&n){var s=u.getElementsByTagName("head")[0]||u.documentElement,z=u.createElement("script");if(b.scriptCharset)z.charset=b.scriptCharset;z.src=b.url;if(!d){var C=false;z.onload=z.onreadystatechange=function(){if(!C&&
(!this.readyState||this.readyState==="loaded"||this.readyState==="complete")){C=true;c.handleSuccess(b,w,e,f);c.handleComplete(b,w,e,f);z.onload=z.onreadystatechange=null;s&&z.parentNode&&s.removeChild(z)}}}s.insertBefore(z,s.firstChild);return B}var H=false,w=b.xhr();if(w){b.username?w.open(h,b.url,b.async,b.username,b.password):w.open(h,b.url,b.async);try{if(b.data!=null&&!k||a&&a.contentType)w.setRequestHeader("Content-Type",b.contentType);if(b.ifModified){c.lastModified[b.url]&&w.setRequestHeader("If-Modified-Since",
...
false?"each":"queue"](function(){var h=c.extend({},f),k,l=this.nodeType===1,n=l&&c(this).is(":hidden"),v=this;for(k in a){var s=c.camelCase(k);if(k!==s){a[s]=a[k];delete a[k];k=s}if(a[k]==="hide"&&n||a[k]==="show"&&!n)return h.complete.call(this);if(l&&(k==="height"||k==="width")){h.overflow=[this.style.overflow,this.style.overflowX,this.style.overflowY];if(c.css(this,"display")==="inline"&&c.css(this,"float")==="none")if(c.support.inlineBlockNeedsLayout)if(pa(this.nodeName)==="inline")this.style.display=
"inline-block";else{this.style.display="inline";this.style.zoom=1}else this.style.display="inline-block"}if(c.isArray(a[k])){(h.specialEasing=h.specialEasing||{})[k]=a[k][1];a[k]=a[k][0]}}if(h.overflow!=null)this.style.overflow="hidden";h.curAnim=c.extend({},a);c.each(a,function(z,C){var H=new c.fx(v,h,z);if(ub.test(C))H[C==="toggle"?n?"show":"hide":C](a);else{var w=vb.exec(C),G=H.cur()||0;if(w){var M=parseFloat(w[2]),g=w[3]||"px";if(g!=="px"){c.style(v,z,(M||1)+g);G=(M||1)/H.cur()*G;c.style(v,z,
...
for(var l=b.offsetTop,n=b.offsetLeft;(b=b.parentNode)&&b!==k&&b!==h;){if(c.offset.supportsFixedPosition&&f.position==="fixed")break;f=e?e.getComputedStyle(b,null):b.currentStyle;l-=b.scrollTop;n-=b.scrollLeft;if(b===d){l+=b.offsetTop;n+=b.offsetLeft;if(c.offset.doesNotAddBorder&&!(c.offset.doesAddBorderForTableAndCells&&wb.test(b.nodeName))){l+=parseFloat(f.borderTopWidth)||0;n+=parseFloat(f.borderLeftWidth)||0}d=b.offsetParent}if(c.offset.subtractsBorderForOverflowNotVisible&&f.overflow!=="visible"){l+=
