$(window)
    ...
    .ready(function () {
        ...
        function e() {
            t ? ($("body")
                    .addClass("scroll-touch"), $("a#open-more-info")
                    .on("click", function () {
        ...
        $("a#open-more-info")
            .on("click", function () {
                $(".overlay")
                    .toggleClass("skew-part"), $("#right-side")
                    .toggleClass("hide-right"), $("#close-more-info")
                    .toggleClass("hide-close"), $(".mCSB_scrollTools")
                    .toggleClass("mCSB_scrollTools-left"), setTimeout(function () {
                        $("#mcs_container")
                            .mCustomScrollbar("scrollTo", "#right-side", {
                                scrollInertia: 500
                                , callbacks: !1
                            })
                    }, 350)
            ...
            .on("click", function () {
                $(".overlay")
                    .addClass("skew-part"), $("#right-side")
                    .addClass("hide-right"), $("#close-more-info")
                    .addClass("hide-close"), $(".mCSB_scrollTools")
                    .removeClass("mCSB_scrollTools-left"), setTimeout(function () {
                        $("#mcs_container")
                            .mCustomScrollbar("scrollTo", "#right-side", {
                                scrollInertia: 500
                                , callbacks: !1
        ...
        e(), window.matchMedia("(min-width: 1025px)")
            .matches && $(function () {
                $("[data-toggle='tooltip']")
                    .tooltip()
            }), $("#notifyMe")
        ...
        var o = function (e) {
            for (var t = function (e) {
                    for (var t = e.childNodes, o = t.length, i = [], n, l, a, r, c = 0; o > c; c++) n = t[c], 1 === n.nodeType && (l = n.children[0], a = l.getAttribute("data-size")
                        .split("x"), r = {
