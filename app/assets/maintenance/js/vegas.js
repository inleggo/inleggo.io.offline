$(window).load(function() {
    ...
    setTimeout(function() {
        ...
        $('body').vegas({
            slides: [
                { src: 'assets/maintenance/img/slider/peru/slide-1.jpg' },
                { src: 'assets/maintenance/img/slider/peru/slide-2.jpg' },
                { src: 'assets/maintenance/img/slider/peru/slide-3.jpg' },
            ],
